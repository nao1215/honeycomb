...
type Author struct {
	NSecretKey     NSecretKey    // NSecretKey is the user's private key.
	NPublicKey     NPublicKey    // NPublicKey is the user's public key.
	PublicKey      PublicKey     // NPublicKey is the user's public key.
